...
df = pd.read_csv(r"C:\Users\avina\Downloads\final_dataset - final_dataset.csv")
df.head()
...
new_df.to_csv(r"C:\Users\avina\Downloads\final_dataset.csv",header=False,index=False,encoding = 'utf-16')